...
public class SettingsActivity extends SherlockActivity { 
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	    switch (item.getItemId()){
	        ...
	        case android.R.id.home:
	            ...
	            Intent intentHome = new Intent(this, UniTnAvvisi.class);
	...
	private void controlla(){
		if(!notifica.isChecked()){  // controlla sela checkbox notifica è checkkata se si abilita le altre se no le disabilita
			...
			/*Iterator<Universita> i = UniTnAvvisi.uni.iterator();
	        while(i.hasNext()){
	        	Universita aux = i.next();
	        	CheckBox tv = (CheckBox) findViewById(1000 + aux.getN());
	    		tv.setText(aux.getNome());
	    		tv.setTextColor(R.color.grigiastro);
	    		tv.setEnabled(false);
	        }*/
