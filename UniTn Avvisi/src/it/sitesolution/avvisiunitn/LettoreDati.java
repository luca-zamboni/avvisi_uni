...
public class LettoreDati {
	...
	final String DIR = Environment.getExternalStorageDirectory()+ "/.SiteSolution/AvvisiUnitn/";
	private String file = "";
	...
	/**
	 *  
	 * Funzione che ritorna un ArrayList degli avvisiBo
	 * 
	...
	private void notifica(String m) {
		...
		Log.e("ciao","sono nella notifica");
		...
		if (settings.getBoolean("notifica", false) && controlla) {
			Intent intent = new Intent(c, UniTnAvvisi.class);
			Notification notification = new Notification( 
					R.drawable.unitn, "Nuovi avvisi in bacheca",
