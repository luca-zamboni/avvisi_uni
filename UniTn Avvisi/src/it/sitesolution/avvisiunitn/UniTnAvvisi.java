 ...
 * 
 */
public class UniTnAvvisi extends SherlockFragmentActivity {
	...
	protected void onResume() {
		...
		/*if(settings.getBoolean("fac"+Static.unicurr.getNome(), false)){
	...
	public boolean onOptionsItemSelected(com.actionbarsherlock.view.MenuItem item) {
		switch (item.getItemId()) { 
			...
			case R.id.info:
				...
				final TextView message = new TextView(UniTnAvvisi.this);
				...
				Dialog dialog = new AlertDialog.Builder(UniTnAvvisi.this)
